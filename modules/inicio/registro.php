            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                <div class="w-full grid mt-3">
                    ...
                    <div class="col flex align-content-center flex-wrap">
                        <input class="estilo-input px-2" placeholder="Usuario" type="text" id="userName" name="userName"
                            required>
                    </div>
                </div>
                        ...
                        <div class="absolute top-0 right-0 mlr-2 mr-3 mt-2 pt-1">
                            <div class="estilo-iconos cursor-pointer" onclick="togglePasswordVisibility()">
                                <svg id="view" xmlns="http://www.w3.org/2000/svg"
                                    style="fill:rgb(59, 59, 59); display: block;"
                                ...
                                <svg id="no-view" xmlns="http://www.w3.org/2000/svg"
                                    style="fill:rgb(59, 59, 59); display: none"
                ...
                <button type="submit" class="estilo-button mt-3">REGISTRARSE AHORA</button>
            </form>
        </div>
    </div>
    <script>
